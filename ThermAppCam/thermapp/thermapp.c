...
int thermapp_USB_checkForDevice(ThermApp *thermapp, int vendor, int product)
{
    ...
    thermapp->dev = libusb_open_device_with_vid_pid(thermapp->ctx, 0x1772,0x0002 );
...
void getRGBimage(){
    //system("adb shell am startservice example.chatea.servicecamera/.PhotoTakingService");
//    system("adb pull /storage/emulated/legacy/Pictures/MyCameraApp/ /home/thecakeisalai/Desktop/thermapp/ThermAppCam/build-thermapp-Desktop_Qt_5_8_0_GCC_64bit-Debug/imagens");
//    system("adb shell rm /storage/emulated/legacy/Pictures/MyCameraApp/*.jpg");
    //system("adb shell ls /storage/emulated/0/Pictures/MyCameraApp");
...
int thermapp_GetImage(ThermApp *thermapp, short *ImgData){
    ...
    //clock_t end_time = 1000 * 1000 + start_time;
